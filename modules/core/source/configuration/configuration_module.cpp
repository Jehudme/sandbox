...
configuration_module_t::configuration_module_t(flecs::world &entity_world) {
  sandbox::modules::logs::trace(entity_world,
                                "Configuration Module Initializing...");
