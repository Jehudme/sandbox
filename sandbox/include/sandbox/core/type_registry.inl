...
namespace sandbox
{
    ...
    std::unique_ptr<base_type> type_registry::instantiate(std::string_view type_name, argument_types&&... constructor_arguments)
    {
    ...
    template<typename... argument_types>
    rttr::variant type_registry::call_static_method(std::string_view class_name, std::string_view method_name, argument_types&&... method_arguments)
    {
        std::vector<rttr::argument> argument_list({ std::forward<argument_types>(method_arguments)... });
