...
namespace sandbox
{
    ...
    public:
        ...
        static rttr::variant call_method(std::string_view method_name, rttr::instance instance, arguments_t&&... method_arguments);
    ...
    private:
        ...
        static rttr::variant internal_call_method(std::string_view method_name, rttr::instance instance, std::vector<rttr::argument> arguments);
